...
namespace HromadskeTV
{
    ...
    {
        private Guid APP_ID = new Guid("786e58c7-ccb8-46af-835e-e15908558c1d");
        public const string APP_NAME = "Hromadske TV";
...
#if WINDOWS_PHONE_APP
            Microsoft.ApplicationInsights.Extensibility.TelemetryConfiguration.Active.ContextInitializers
                .Add(new Telemetry.TelemetryInitializer("Windows Phone 8.1"));
#else
            Microsoft.ApplicationInsights.Extensibility.TelemetryConfiguration.Active.ContextInitializers
                .Add(new Telemetry.TelemetryInitializer("Windows 8.1"));
#endif
        }
...
#endif
            ApplicationData.Current.LocalSettings.Values[LocalSettingNames.DeviceTypeSetting] = deviceType;
            ApplicationData.Current.LocalSettings.Values[LocalSettingNames.StoreIdSetting] = ValidateStoreId();
        }
        ...
        private void UpdateAppTiles()
        {
            ...
            {
                TileServices.CreateFlipTile(@":)", @"Лілія, в тебе чарівна посмішка");
